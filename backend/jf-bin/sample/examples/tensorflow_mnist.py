...
parser = argparse.ArgumentParser(description='TF MNIST Example')
parser.add_argument('--batch-size', type=int, default=64, metavar='N',
                    help='input batch size for training (default: 64)')
parser.add_argument('--step', type=int, default=20000, metavar='N',
...
def main(_):
    ...
    hooks = [
        ...
        tf.train.StopAtStepHook(last_step=args.step // hvd.size()),
