...
def create_ingress(ingress_name, ingress_path, rewrite_target_path, service_name, service_port_number, labels={},
    ...
    try:
        ...
        try:
            extensV1Api.delete_namespaced_ingress(name=ingress_name, namespace="default")
            extensV1Api.create_namespaced_ingress(body=body, namespace="default")
        except:
            traceback.print_exc()
            return False
...
def create_pod(body, pod_name, labels, gpu_count, gpu_model, cpu_model, **kwargs):
    """
    Description :
