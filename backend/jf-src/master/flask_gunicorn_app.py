...
# 3.8에서 bin로 만들면 BASE_DIR 경로가 /tmp/_MEIADRwYG/ 로 잡힘 
# /jf-src/master/ 를 찾도록 처리 필요
...
parser.add_argument('--ini', type=str, required=False, help="gunicorn.ini path", default="{}/gunicorn.ini".format(BASE_DIR))
